...
public class Veternary extends AppCompatActivity {
    RecyclerView rv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_veternary);
...
//        calling=findViewById(R.layout.call);
    ...
    private void displayEntry() {
        Cursor cursor=DB.getVet();
        if(cursor.getCount()==0){
            Toast.makeText(Veternary.this,"No Entry Exists",Toast.LENGTH_SHORT).show();
            return;
        }
        else{
